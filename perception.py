...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,0] = obstacles * 255 #red obstacles
    Rover.vision_image[:,:,1] = samples_area * 255 #green rocks
    Rover.vision_image[:,:,2] = navigable_area * 255 # blue navigable terrain ahead
